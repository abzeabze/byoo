...
const excelUtil = require("../../scripts/createFile");
...
class fileoutput extends command_1.SfdxCommand {
    ...
    async run() {
        ...
        var combinedMetadata = new Array();
        //var lstRecTypes = new Array<recordType>();
        var lstpageLayoutInfo = new Array();
        var mpObjectPageLayouts = new Map();
        ...
        for (var i = 0; i < objNames.length; i++) {
            ...
            var objLayouts = layoutResult;
            var lstRecTypesByObject = objLayouts.recordTypeMappings;
                    ...
                    for (var p = 0; p < lstLayoutRows.length; p++) {
                        ...
                        for (var q = 0; q < lstLayoutItem.length; q++) {
                            ...
                            for (var r = 0; r < lstComponents.length; r++) {
                                var fieldDetail = {};
                                let fieldInfo = lstComponents[r].details;
                                //this.ux.log('Check 2'); 
        ...
        for (var i = 0; i < lstpageLayoutInfo.length; i++) {
            let lstPage = mpObjectPageLayouts.get(lstpageLayoutInfo[i].objectName);
            if (!lstPage) {
                lstPage = new Array();
            }
        ...
        */
        ...
        for (var i = 0; i < objNames.length; i++) {
            ...
            try {
                ...
                var objRes = fldResult;
                let lstPage = mpObjectPageLayouts.get(objRes.name.toLowerCase());
                //this.ux.log('***1');
...
fileoutput.description = messages.getMessage('schemaCommandDescription');
fileoutput.examples = [
...
fileoutput.requiresUsername = true;
// Comment this out if your command does not support a hub org username
fileoutput.supportsDevhubUsername = true;
// Set this to true if your command requires a project workspace; 'requiresProject' is false by default
fileoutput.requiresProject = false;
fileoutput.flagsConfig = {
    ...
    path: command_1.flags.string({ char: 'p', description: messages.getMessage('pathFlagDescription') }),
    objects: command_1.flags.string({ char: 'o', description: messages.getMessage('objectFlagDescription') }),
};
